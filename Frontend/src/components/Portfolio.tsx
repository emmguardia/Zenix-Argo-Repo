...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Site institutionnel pour l'association Club Quisine, présentant l'équipe, les repas hebdomadaires et les événements culinaires.",
      image: "/images/club-quisine.webp",
      technologies: ["React", "TailwindCSS", "K3s", "Vite"],
