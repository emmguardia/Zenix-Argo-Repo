    ...
    <section className="py-20 bg-white pt-32" ref={sectionRef}>
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-ink-900 mb-4">Création de Site Vitrine Professionnel</h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {features.map((feature, index) => (
            <div key={index} className="bg-ink-50 rounded-xl p-6 hover:shadow-lg transition-all duration-300">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div className="bg-brand-50 rounded-2xl p-8">
            <h2 className="text-3xl font-bold text-ink-900 mb-6">Ce qui est inclus</h2>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-ink-200">
            <h2 className="text-3xl font-bold text-ink-900 mb-6">Optimisations SEO & Sécurité</h2>
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold text-ink-900 mb-3 flex items-center">
                  <Search className="w-5 h-5 text-brand-600 mr-2" />
                  SEO Technique
                </h3>
        ...
        <div className="bg-ink-50 rounded-2xl p-8 md:p-12">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-ink-900 mb-2">Consultation</h3>
              <p className="text-ink-600 text-sm">Analyse de vos besoins et objectifs</p>
            </div>
            <div className="text-center">
              <div className="bg-brand-600 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 text-xl font-bold">
                2
              ...
              <p className="text-ink-600 text-sm">Maquettes et validation du design</p>
            </div>
            <div className="text-center">
              <div className="bg-brand-600 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 text-xl font-bold">
                3
              ...
              <p className="text-ink-600 text-sm">Création et optimisation du site</p>
            </div>
            <div className="text-center">
              <div className="bg-brand-600 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 text-xl font-bold">
                4
