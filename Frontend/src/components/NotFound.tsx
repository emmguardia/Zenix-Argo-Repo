  ...
  return (
    <section className="py-20 bg-white pt-32 min-h-[70vh] flex items-center">
      <div className="container mx-auto px-6 max-w-2xl text-center">
        ...
        <p className="text-sm font-semibold text-brand-600 mb-2">Erreur 404</p>
        <h1 className="text-4xl font-bold text-ink-900 mb-4">Cette page n'existe pas</h1>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-10">
          {suggestions.map((item) => (
            <Link
              ...
              className="bg-ink-100 hover:bg-ink-200 text-ink-900 font-medium py-2 px-5 rounded-full transition-colors"
            >
              {item.name}
            </Link>
          ))}
